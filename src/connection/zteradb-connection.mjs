...
import { ZTeraDBError } from '@zteradb/client/helper/zteradb-exception';
import ZTeraDBQuery from '@zteradb/client/query';
import ZTeraDBClientAuth from '@zteradb/client/auth/client-auth';
...
class ZTeraDBConnectionManager {
  ...
  constructor(ZTeraDBHost, ZTeraDBPort, ZTeraDBConfig) {
    ...
    this.hasMinConnectionPoolOption = ZTeraDBConfig.options && ZTeraDBConfig.options.connectionPool && ZTeraDBConfig.options.connectionPool.min > 0;
    this.hasMaxConnectionPoolOption = ZTeraDBConfig.options && ZTeraDBConfig.options.connectionPool && ZTeraDBConfig.options.connectionPool.max > 0;

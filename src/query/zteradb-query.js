...
const { ZTeraDBQueryError } = require("@zteradb/client/helper/zteradb-exception");
const FilterTypes = require("@zteradb/client/constants/zteradb-filter-types");
...
module.exports = ZTeraDBQuery;

module.exports.isValidSchemaField = isValidSchemaField;

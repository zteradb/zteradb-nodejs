/**
 * @file query/zteradb-filter-conditions.js
 * 
 * --------------------------------------------------------------------------
...
const { ZTeraDBConditionError } = require("@zteradb/client/helper/zteradb-exception"); // ZTERADB error handling
const FilterTypes = require("@zteradb/client/constants/zteradb-filter-types"); // Import ZTERADB filter operators like ADD, SUB, etc.

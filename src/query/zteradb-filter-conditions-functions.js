/**
 * @file query/zteradb-filter-conditions-functions.js
 * 
 * --------------------------------------------------------------------------
...
const { FilterCondition } = require("../query/zteradb-filter-conditions");
...
module.exports = {
  ...
  ZTSUB,          // Export ZTSUB for substraction of two or more fields

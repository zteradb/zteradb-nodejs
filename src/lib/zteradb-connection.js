 ...
 * 
 * const zTeraDB = new ZTeraDBConnect({
...
const RequestType = require("../constants/zteradb-request-types");
const ResponseType = require("../constants/zteradb-response-types");

const { AuthenticationError, ZTeraDBError, NoResponseDataError, QueryComplete } = require("../helper/zteradb-exception");
const { sha256 } = require("../helper/zteradb-common");
const { ZTeraDBQuery } = require("./zteradb-query");
  ...
  handleResponse(parsedResponse, connectionManager=false) {
    ...
    switch (parsedResponse.response_code) {
      ...
      default:
        ...
        throw new ZTeraDBError("Connection error", -1, parsedResponse.data);
    }
  }
  ...
  async getConnection() {
    ...
    try {
      ...
      if(connection) {
        ...
        throw new ZTeraDBError("Unable to get  or create  the ZTeraDB connection")
      }
    }
  }

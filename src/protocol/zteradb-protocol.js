...
const ZTeraDBConnectionManager = require("@zteradb/client/connection/zteradb-connection");
const { AuthenticationError, ZTeraDBError, QueryComplete } = require("@zteradb/client/helper/zteradb-exception");
const RequestType = require("@zteradb/client/constants/zteradb-request-types");
...
class ZTeraDBProtocol {
  ...
  async *getData(connectionManager=null) {
    ...
    try{
      ...
      if (connectionManager && typeof connectionManager === 'function' && data instanceof ZTeraDBConnectionManager) {
...
module.exports = ZTeraDBProtocol;
